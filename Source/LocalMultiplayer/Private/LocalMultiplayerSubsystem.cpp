...
// Supposition = assigne un nouveau PlayerIndex � un KeyboardProfile
...
// R�cup�re l'IMC du KeyboardProfileIndex donn� -> puis avec le PlayerIndex on r�cup le PlayerController pour lui assigner le mapping context
...
// Supposition = assigne un nouveau PlayerIndex � un GamepadDeviceID (GamepadProfile)
...
// R�cup�re l'IMC -> puis avec le PlayerIndex on récup le PlayerController pour lui assigner le mapping context
